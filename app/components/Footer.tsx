...
const Footer = () => {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mt-18 text-gray-800">
            <nav aria-labelledby="quick-links-heading">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <button onClick={handleCancelBooking} className="hover:!text-primary transition-colors !text-sm">Cancel Booking</button>
                </li>
              </ul>
            </nav>
      ...
      <CancelBookingModal open={openCancelBookingModal} onClose={() => setOpenCancelBookingModal(false)} />
    </>
  );
};
