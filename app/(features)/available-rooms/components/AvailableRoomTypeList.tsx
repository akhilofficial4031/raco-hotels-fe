      ...
      <div className="flex flex-col gap-16">
        {roomTypes.map((roomType) => (
          <div
            ...
            className="group bg-background-light rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col lg:flex-row min-h-[400px]"
          >
